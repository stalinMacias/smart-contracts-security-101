...
describe("Vault", function () {
  ...
  beforeEach(async function () {
    ...
    // formatBytes32String() Returns a bytes32 string representation of text. 
  ...
  it("Should be possible to access to its private variables", async function () {
    ...
    // parseBytes32String() Returns the decoded string represented by the Bytes32 encoded data.
